...
import { getWeek } from "../../../utills/helper";
...
const MyStoreScreen = ({ navigation, route }) => {
  ...
  const [validationSchema, setValidationSchema] = useState(
    Yup.object().shape({
      ...
      slogan: Yup.string().label(t("myStoreTexts.errorFieldNames.slogan")),
      email: Yup.string()
        .required(
      ...
      address: Yup.string().label(t("myStoreTexts.errorFieldNames.address")),
      website: Yup.string().url(t("myStoreTexts.formValidation.validUrl")),
      facebook: Yup.string().url(t("myStoreTexts.formValidation.validUrl")),
      youtube: Yup.string().url(t("myStoreTexts.formValidation.validUrl")),
      twitter: Yup.string().url(t("myStoreTexts.formValidation.validUrl")),
      linkedin: Yup.string().url(t("myStoreTexts.formValidation.validUrl")),
  ...
  const [weekDays, setWeekDays] = useState(getWeek() || {});
  ...
  return (
    <ScreenWrapper
      ...
      scrollEnabled={userHasNoStore ? false : false}
    >
      {loading ? (
                    ...
                    {({
                      ...
                      <View style={styles.storeSectionComponent}>
                        <View style={[styles.storeSectionTitleWrap, rtlView]}>
                          ...
                          >
                            <Text
                              style={[styles.storeSectionTitleText, rtlText]}
                            >
                              {t("myStoreTexts.info")}
                            </Text>
                          </View>
                        ...
                        <View style={styles.storeSectionContentWrap}>
                          <View style={styles.storeInputWrap}>
                            ...
                            <TextInput
                              placeholder={t("myStoreTexts.placeHolders.slug")}
                            ...
                            <View style={styles.storeInputErrorWrap}>
                              {errors.slug && touched.slug && (
                                <Text
                                  style={[styles.storeInputError, rtlTextA]}
                                >
                                  {errors.slug}
                                </Text>
                              )}
                          ...
                          <View style={styles.storeInputWrap}>
                            ...
                            <TextInput
                              placeholder={t("myStoreTexts.placeHolders.title")}
                              placeholderTextColor={AppColors.text_gray}
                              style={[styles.storeInput, rtlTextA]}
                          ...
                          <View style={styles.storeInputWrap}>
                            ...
                            <TextInput
                              placeholder={t("myStoreTexts.placeHolders.email")}
                              placeholderTextColor={AppColors.text_gray}
                              style={[styles.storeInput, rtlTextA]}
                          ...
                          <View style={styles.storeInputWrap}>
                            ...
                            <TextInput
                              placeholder={t("myStoreTexts.placeHolders.phone")}
                              placeholderTextColor={AppColors.text_gray}
                              style={[styles.storeInput, rtlTextA]}
                        ...
                        <View style={styles.updateButtonWrap}>
                          <AppButton
                            title={t("myStoreTexts.updateStoreButtonTitle")}
